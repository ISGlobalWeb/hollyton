...
<header>
<div class="banner">
<img src="<?php echo GLOBAL_PATH;?>/assets/images/contact-banner.jpg" alt="Contact Hollyton Banner" >
</div>
...
<p>If you don't already have our contact details, please feel free to call Sam on X to discuss any aspect of our service.</p
></div>
...
<form method="post" action="" name="contact">
	...
	<li>
		...
		<textarea class="" rows="5" name="comments" cols="29"></textarea>
	</li>
